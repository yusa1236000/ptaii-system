    ...
    <aside class="sidebar" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
      ...
      <nav class="sidebar-menu">
        ...
        <div class="menu-section">
          <div @click="toggleMenuSection('inventory')" class="section-header">
            <div class="section-title-container">
              <i class="fas fa-box"></i>
              <span v-if="!sidebarCollapsed" class="section-title">Inventory</span>
            </div>
            <i v-if="!sidebarCollapsed" 
              :class="menuSections.inventory ? 'fas fa-chevron-down' : 'fas fa-chevron-right'" 
              class="section-icon"></i>
          </div>
        </div>
        
        <div v-show="!sidebarCollapsed && menuSections.inventory" class="submenu">
          <router-link to="/items" class="menu-item" active-class="active">
            <i class="fas fa-cubes"></i>
            <span v-if="!sidebarCollapsed">Items</span>
          </router-link>
          
          <router-link to="/item-categories" class="menu-item" active-class="active">
            <i class="fas fa-tags"></i>
            <span v-if="!sidebarCollapsed">Categories</span>
          </router-link>
          
          <router-link to="/unit-of-measures" class="menu-item" active-class="active">
        ...
        <div class="menu-section">
          <div @click="toggleMenuSection('stockOperations')" class="section-header">
            <div class="section-title-container">
              <i class="fas fa-exchange-alt"></i>
              <span v-if="!sidebarCollapsed" class="section-title">Stock Operations</span>
            </div>
            <i v-if="!sidebarCollapsed" 
              :class="menuSections.stockOperations ? 'fas fa-chevron-down' : 'fas fa-chevron-right'" 
              class="section-icon"></i>
          </div>
        </div>
        
        <div v-show="!sidebarCollapsed && menuSections.stockOperations" class="submenu">
        ...
        <!-- Sales Section -->
        <div class="menu-section">
          <div @click="toggleMenuSection('sales')" class="section-header">
            <div class="section-title-container">
              <i class="fas fa-shopping-cart"></i>
              <span v-if="!sidebarCollapsed" class="section-title">Sales</span>
            </div>
            <i v-if="!sidebarCollapsed" 
              :class="menuSections.sales ? 'fas fa-chevron-down' : 'fas fa-chevron-right'" 
              class="section-icon"></i>
          </div>
        </div>
        
        <div v-show="!sidebarCollapsed && menuSections.sales" class="submenu">
          <router-link to="/sales/customers" class="menu-item" active-class="active">
            <i class="fas fa-users"></i>
            <span v-if="!sidebarCollapsed">Customers</span>
          </router-link> 
          
          <router-link to="/sales/quotations" class="menu-item" active-class="active">
          ...
          <router-link to="/sales/deliveries" class="menu-item" active-class="active">
            <i class="fas fa-truck"></i>
            <span v-if="!sidebarCollapsed">Deliveries</span>
          </router-link>
          
          <router-link to="/sales/invoices" class="menu-item" active-class="active">
            <i class="fas fa-file-invoice"></i>
            <span v-if="!sidebarCollapsed">Invoices</span>
          </router-link>
          
          <router-link to="/sales/returns" class="menu-item" active-class="active">
        ...
        <!-- Reports Section -->
        <div class="menu-section">
          <div @click="toggleMenuSection('reports')" class="section-header">
            <div class="section-title-container">
              <i class="fas fa-chart-bar"></i>
              <span v-if="!sidebarCollapsed" class="section-title">Reports</span>
            </div>
            <i v-if="!sidebarCollapsed" 
              :class="menuSections.reports ? 'fas fa-chevron-down' : 'fas fa-chevron-right'" 
              class="section-icon"></i>
          </div>
        </div>
        
        <div v-show="!sidebarCollapsed && menuSections.reports" class="submenu">
        ...
        <!-- Admin Section -->
        <div class="menu-section">
          <div @click="toggleMenuSection('admin')" class="section-header">
            <div class="section-title-container">
              <i class="fas fa-user-shield"></i>
              <span v-if="!sidebarCollapsed" class="section-title">Admin</span>
            </div>
            <i v-if="!sidebarCollapsed" 
              :class="menuSections.admin ? 'fas fa-chevron-down' : 'fas fa-chevron-right'" 
              class="section-icon"></i>
          </div>
        </div>
        
        <div v-show="!sidebarCollapsed && menuSections.admin" class="submenu">
...
export default {
  ...
  setup() {
    ...
    const initializeActiveSection = () => {
      ...
      if (path.includes('/items') || path.includes('/item-categories') || 
          path.includes('/unit-of-measures') || path.includes('/warehouses')) {
        menuSections.inventory = true;
      } else if (path.includes('/stock-transactions') || path.includes('/stock-adjustments') || 
    ...
    const pageTitle = computed(() => {
      switch (route.name) {
        ...
        case 'SalesQuotations': return 'Sales Quotations';
