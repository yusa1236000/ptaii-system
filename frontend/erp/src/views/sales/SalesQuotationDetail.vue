          ...
          <div class="card-body">
            <div class="info-grid">
              ...
              <div class="info-group">
                ...
                <div class="info-value">{{ formatDate(quotation.validity_date) }}</div>
              </div>
          ...
          <div class="card-body">
            <div class="customer-info">
              ...
              <div class="info-group">
                ...
                <div class="info-value">{{ quotation.customer.customer_code }}</div>
              </div>
              ...
              <div class="info-group">
                <label>NPWP</label>
                <div class="info-value">{{ quotation.customer.tax_id || '-' }}</div>
              </div>
              
              <div class="info-group">
                <label>Contact Person</label>
                <div class="info-value">{{ quotation.customer.contact_person || '-' }}</div>
              </div>
          ...
          <div class="card-body">
            <div class="quotation-items">
              <table class="items-table">
                ...
                <tbody>
                  <tr v-for="line in quotation.salesQuotationLines" :key="line.line_id">
                    <td>
                      <div class="item-info">
                    ...
                    <td>{{ formatCurrency(line.discount || 0) }}</td>
                ...
                <tfoot>
                  <tr>
                    ...
                    <td colspan="2" class="totals-value">{{ formatCurrency(calculateSubtotal()) }}</td>
                  </tr>
                  <tr>
                    <td colspan="6" class="totals-label">Total Diskon</td>
                    <td colspan="2" class="totals-value">{{ formatCurrency(calculateTotalDiscount()) }}</td>
                  </tr>
                  <tr>
                    <td colspan="6" class="totals-label">Total Pajak</td>
                    <td colspan="2" class="totals-value">{{ formatCurrency(calculateTotalTax()) }}</td>
                  </tr>
                  <tr class="grand-total">
                    <td colspan="6" class="totals-label">Total</td>
                    <td colspan="2" class="totals-value">{{ formatCurrency(calculateGrandTotal()) }}</td>
                  </tr>
                </tfoot>
              </table>
            </div>
          ...
          <div class="card-body">
            <div class="related-orders">
              <table class="related-table">
                ...
                <tbody>
                  <tr v-for="order in quotation.salesOrders" :key="order.so_id">
                    ...
                    <td>
                      <button class="btn btn-sm btn-secondary" @click="viewSalesOrder(order)">
    ...
    setup() {
      ...
      const loadData = async () => {
        ...
        try {
          ...
          const quotationResponse = await axios.get(`/quotations/${route.params.id}`);
      ...
      const calculateTotalDiscount = () => {
        if (!quotation.value || !quotation.value.salesQuotationLines) return 0;
        return quotation.value.salesQuotationLines.reduce((sum, line) => sum + (line.discount || 0), 0);
      };
      ...
      const convertToOrder = () => {
        router.push(`/orders/create-from-quotation/${quotation.value.quotation_id}`);
      };
      ...
      const updateStatus = async (newStatus) => {
        try {
          ...
          alert(`Status penawaran berhasil diubah menjadi ${getStatusLabel(newStatus)}`);
        } catch (error) {
