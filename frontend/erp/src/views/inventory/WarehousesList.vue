                ...
                >
                    <div class="warehouse-header">
                        <div
                            ...
                            :class="{ inactive: !warehouse.is_active }"
                        >
                ...
                setTimeout(() => {
                    warehouses.value = [
                        ...
                        },
                        {
                            ...
                            code: "WH-004",
                            address:
                                "101 Old Factory Rd, Industrial Area, City",
                            is_active: false,
                            zones: [],
                            itemCount: 0,
                        },
            ...
            try {
                if (isEditMode.value) {
                    ...
                    const index = warehouses.value.findIndex(
                        (wh) =>
                            wh.warehouse_id === warehouseForm.value.warehouse_id
                    );
                    if (index !== -1) {
                ...
                alert(
                    "An error occurred while saving the warehouse. Please try again."
                );
            }
        };
        ...
        const deleteWarehouse = async () => {
            try {
                ...
                warehouses.value = warehouses.value.filter(
                    (wh) =>
                        wh.warehouse_id !== warehouseToDelete.value.warehouse_id
                );
                ...
                alert(
                    "An error occurred while deleting the warehouse. Please try again."
                );
            }
        };
