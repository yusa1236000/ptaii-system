    ...
    setup() {
      ...
      const saveCategory = async () => {
        try {
          if (isEditMode.value) {
            // In a real app, this would be an API call
            // await axios.put(`/api/item-categories/${categoryForm.value.category_id}`, categoryForm.value);
            ...
            // In a real app, this would be an API call
            // const response = await axios.post('/api/item-categories', categoryForm.value);
      ...
      const deleteCategory = async () => {
        try {
          ...
          // In a real app, this would be an API call
          // await axios.delete(`/api/item-categories/${categoryToDelete.value.category_id}`);
